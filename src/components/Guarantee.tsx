      ...
      <div className="relative container mx-auto px-6">
        <div className="max-w-3xl mx-auto text-center">
          <div className="mb-8 md:mb-12">
            <div ref={iconRef} className="w-12 h-12 bg-orange-400/25 backdrop-blur-sm rounded-xl flex items-center justify-center mx-auto mb-6 md:mb-8 border border-orange-300/40">
              <div className="w-6 h-6 rounded-full bg-orange-400/50 flex items-center justify-center">
          ...
          <div ref={cardRef} className="bg-white/70 backdrop-blur-sm border border-white/50 rounded-xl p-6 md:p-8 mb-8 md:mb-12 mx-4 sm:mx-0 shadow-sm">
