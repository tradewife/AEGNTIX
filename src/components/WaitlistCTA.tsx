...
const WaitlistCTA = () => {
  ...
  if (isSubmitted) {
    return (
      <section className="relative bg-gradient-to-br from-yellow-100/90 via-orange-50/85 to-orange-100/80 py-16 md:py-24">
  ...
  return (
    <section className="relative bg-gradient-to-br from-yellow-100/90 via-orange-50/85 to-orange-100/80 overflow-hidden py-16 md:py-24" ref={sectionRef}>
