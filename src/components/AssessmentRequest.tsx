...
const AssessmentRequest = () => {
  ...
  if (isSubmitted) {
    return (
      <section data-section="assessment" className="relative min-h-screen flex items-center overflow-hidden">
        {/* Pure geometric abstraction background - NO FILTERS, ZOOMED OUT */}
        ...
        <div className="relative container mx-auto px-6 py-16 md:py-24">
          <div className="max-w-2xl mx-auto text-center">
            <div className="mb-8 md:mb-12">
              <div className="w-12 h-12 bg-white/10 backdrop-blur-sm rounded-xl flex items-center justify-center mx-auto mb-6 md:mb-8 border border-white/20">
            ...
            <p className="text-base md:text-lg text-white/90 mb-6 md:mb-8 font-light leading-relaxed px-4 sm:px-0 drop-shadow-md">
            ...
            <div className="bg-white/10 backdrop-blur-sm border border-white/20 rounded-xl p-4 md:p-6 text-left mx-4 sm:mx-0 shadow-xl">
              <p className="font-medium text-white mb-2">What happens next?</p>
              <ul className="text-white/80 font-light text-sm md:text-base space-y-2">
  ...
  return (
    <section data-section="assessment" className="relative min-h-screen flex items-center overflow-hidden" ref={sectionRef}>
      {/* Pure geometric abstraction background - NO COLOR FILTERS, ZOOMED OUT FOR FULL VIEW */}
      <div className="absolute inset-0">
        <img 
          src="/trade.wife_Minimalist_geometric_abstraction_soft-edged_polygo_59fb53ac-cdd1-498e-a288-2a78fcbbe428_0.png" 
          alt="Geometric abstraction background" 
      ...
      {/* Minimal dark overlay for text readability - NO COLOR TINTING */}
      ...
      <div className="relative container mx-auto px-6 py-16 md:py-24">
        <div className="max-w-4xl mx-auto">
          <div className="text-center mb-8 md:mb-12">
            ...
            <p ref={subtitleRef} className="text-base md:text-lg text-white/90 font-light leading-relaxed px-4 sm:px-0 max-w-2xl mx-auto drop-shadow-md">
          ...
          <div className="grid md:grid-cols-3 gap-6 mb-8 md:mb-12 px-4 sm:px-0">
            {assessmentFeatures.map((feature, index) => (
              <div 
                ...
                className="text-center p-4 bg-white/10 backdrop-blur-sm rounded-xl border border-white/20 shadow-lg"
              >
                ...
                <p className="text-sm text-white/70 font-light">{feature.description}</p>
              </div>
            ))}
          </div>

          <div ref={formRef} className="bg-black/40 backdrop-blur-sm border border-white/20 rounded-xl shadow-xl p-6 md:p-8 mx-4 sm:mx-0 max-w-2xl mx-auto">
            <form onSubmit={handleSubmit} className="space-y-4 md:space-y-6">
              ...
              <div ref={el => fieldsRef.current[0] = el}>
                ...
                <input
                  ...
                  className={`w-full px-4 py-3 rounded-lg border transition-all duration-200 focus:outline-none focus:ring-2 focus:ring-white/30 text-slate-900 placeholder-slate-500 bg-white/95 backdrop-blur-sm ${
                    errors.website 
              ...
              <div ref={el => fieldsRef.current[2] = el}>
                ...
                <select
                  ...
                  className={`w-full px-4 py-3 rounded-lg border transition-all duration-200 focus:outline-none focus:ring-2 focus:ring-white/30 text-slate-900 bg-white/95 backdrop-blur-sm ${
                    errors.persona 
                      ? 'border-red-400/50 focus:border-red-400' 
                      : 'border-white/30 focus:border-white/60'
                  }`}
              ...
              <button
                ...
                className="w-full bg-white/20 hover:bg-white/30 text-white py-3 px-6 rounded-lg font-medium transition-all duration-300 disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center shadow-lg backdrop-blur-sm border border-white/30"
              >
                {isSubmitting ? (
                  <>
            ...
            <p className="text-center text-xs md:text-sm text-white/70 mt-4 md:mt-6 font-light">
